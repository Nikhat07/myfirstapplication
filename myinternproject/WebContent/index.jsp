...
<div class="main_div">
	...
	<div class="page_wrapper">
			...
			<header class="header_div">
				...
				<div class="header_logo">
					<h2>Welcome to Login module of Rinamp Bank!!!</h2>
				</div>
			</header>
...
<!-- 	----------------------------------------------------------------------------------------------------- -->		
			...
			<div class="form_field">
				<label>User ID*</label>
				<input type="text" id="firstname" name="firstname" class="name_emp" placeholder="Enter Your User Id" autocomplete="off">
			</div>
			<div class="form_field">
				<label>Password	</label>
				<input type="text" id="name" name="middlename" class="name_emp" placeholder="Enter Your Password" autocomplete="off">
			</div>
			<div class="form_field">
				<label>Captcha	</label>
				<input type="text" id="name" name="middlename" class="name_emp" placeholder="Enter Your Password" autocomplete="off">
